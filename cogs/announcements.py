...
class Announcements(utils.ExecCog):
    ...
    def create_title(self, title):
        ...
        d.text((outline / 2 + 3, outline - 3), title, font=self.font, fill=self.main_colour, stroke_width=outline,
    ...
    def create_subtitle(self, title):
        ...
        d.text((img.width / 2 - w / 2, outline - 3), title, font=self.subfont, fill=self.main_colour, stroke_width=outline,
               stroke_fill=self.outline_colour)
